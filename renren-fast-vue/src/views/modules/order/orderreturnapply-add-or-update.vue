  ...
  >
    ...
    >
      ...
      <el-form-item label="申请时间" prop="createTime">
        <el-input v-model="dataForm.createTime" placeholder="申请时间">
        </el-input>
      </el-form-item>
      <el-form-item label="会员用户名" prop="memberUsername">
        <el-input v-model="dataForm.memberUsername" placeholder="会员用户名">
        </el-input>
      </el-form-item>
      <el-form-item label="退款金额" prop="returnAmount">
        <el-input v-model="dataForm.returnAmount" placeholder="退款金额">
        </el-input>
      </el-form-item>
      <el-form-item label="退货人姓名" prop="returnName">
        <el-input v-model="dataForm.returnName" placeholder="退货人姓名">
        </el-input>
      </el-form-item>
      <el-form-item label="退货人电话" prop="returnPhone">
        <el-input v-model="dataForm.returnPhone" placeholder="退货人电话">
        </el-input>
      </el-form-item>
      <el-form-item
      ...
      <el-form-item label="处理时间" prop="handleTime">
        <el-input v-model="dataForm.handleTime" placeholder="处理时间">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="描述" prop="description述">
        <el-input v-model="dataForm.description述" placeholder="描述">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="处理备注" prop="handleNote">
        <el-input v-model="dataForm.handleNote" placeholder="处理备注">
        </el-input>
      </el-form-item>
      <el-form-item label="处理人员" prop="handleMan">
        <el-input v-model="dataForm.handleMan" placeholder="处理人员">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="收货时间" prop="receiveTime">
        <el-input v-model="dataForm.receiveTime" placeholder="收货时间">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="收货电话" prop="receivePhone">
        <el-input v-model="dataForm.receivePhone" placeholder="收货电话">
        </el-input>
      </el-form-item>
      <el-form-item label="公司收货地址" prop="companyAddress">
        <el-input v-model="dataForm.companyAddress" placeholder="公司收货地址">
        </el-input>
      </el-form-item>
    </el-form>
