  ...
  >
    ...
    >
      <el-form-item label="订单号（对外业务号）" prop="orderSn">
        <el-input v-model="dataForm.orderSn" placeholder="订单号（对外业务号）">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="支付总金额" prop="totalAmount">
        <el-input v-model="dataForm.totalAmount" placeholder="支付总金额">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="支付状态" prop="paymentStatus">
        <el-input v-model="dataForm.paymentStatus" placeholder="支付状态">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="确认时间" prop="confirmTime">
        <el-input v-model="dataForm.confirmTime" placeholder="确认时间">
        </el-input>
      </el-form-item>
      <el-form-item label="回调内容" prop="callbackContent">
        <el-input v-model="dataForm.callbackContent" placeholder="回调内容">
        </el-input>
      </el-form-item>
      <el-form-item label="回调时间" prop="callbackTime">
        <el-input v-model="dataForm.callbackTime" placeholder="回调时间">
        </el-input>
      </el-form-item>
    </el-form>
