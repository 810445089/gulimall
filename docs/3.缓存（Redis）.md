...
## 2.读模式缓存使用流程
 ...
 ![1635512623631](./assert/1635512623631.png)

 ![1635512538828](./assert/1635512538828.png)
...
![1635513182709](./assert/1635513182709.png)
...
![1635513259851](./assert/1635513259851.png)
...
```
 ...
 ![1635514358072](./assert/1635514358072.png)
...
```
 ...
 ![1635663356474](./assert/1635663356474.png)
...
```
 ...
 ![1635663592317](./assert/1635663592317.png)
...
```
 ...
 ![1635664198425](./assert/1635664198425.png)
...
发送命令至全部会话：
 ...
 ![1635669533421](./assert/1635669533421.png)

锁值：

 ![1635670061333](./assert/1635670061333.png)
...
```
 ...
 ![1635670158689](./assert/1635670158689.png)

 ![1635673350495](./assert/1635673350495.png)
...
![1597734236213](./assert/1597734236213.png)

读锁：

![1597734296729](./assert/1597734296729.png)

读锁同时存入多个：

 ![1597735057026](./assert/1597735057026.png)
...
![1635689277138](./assert/1635689277138.png)
...
![1635689625640](./assert/1635689625640.png)
...
![1635691115207](./assert/1635691115207.png)

![1635692249946](./assert/1635692249946.png)
...
![1635863295094](./assert/1635863295094.png)
...
![1597740655126](./assert/1597740655126.png)
...
redis缓存管理器源码，会初始化过期时间、key前缀、空数据是否缓存、是否使用缓存前缀![1636030148580](./assert/1636030148580.png)
